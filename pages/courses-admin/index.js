...
import { getAllUnconfirmedCourses } from '../api/courses'
...
export default function CoursesAdmin() {
  ...
  useEffect(()=>{
    getAllUnconfirmedCourses().then(data => {
      setCourses(data);
    }).catch(err => {
      console.log(err);
    });
  ...
  return (
    <>
      <Head>
        <title>VEDUS | Onay Bekleyen Özel Dersler</title>
        ...
        <div>
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-10">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900">Onay Bekleyen Özel Dersler</h1>
                ...
                <div className="lg:col-span-3">
                  <div className="bg-white">
                    <div className="mx-auto max-w-2xl px-4 py-2 sm:px-6 sm:py-2 lg:max-w-7xl lg:px-8">
                      <h2 className="sr-only">Onay Bekleyen Özel Dersler</h2>
                      <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                        ...
                        )): (<p>Onay bekleyen ders bulunmamaktadır...</p>)}
                      </div>
                    </div>
                  </div>
                </div>
