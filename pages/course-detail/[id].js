          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mt-6 items-center pt-2 border-t-2 border-gray-200">
                ...
                <button className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center hover:bg-gray-300 hover:text-red-600 text-gray-500 ml-4" onClick={()=>addReceivedCourse(user?.detail.user_id,id)}>
